...
SWEP.Animations = {
    ...
    ["Reload"] = {
        ...
        Events = {
            ...
            {Time = 0.63, Callback = function(self) self:DoSound(Sound("mw_ar2.magout")) end},
            ...
            {Time = 2, Callback = function(self) self:DoSound(Sound("mw_ar2.magin")) end},
   ...
   ["Reload_Fast"] = {
    ...
    ["Reload_Empty"] = {
        ...
        Events = {
            ...
            {Time = 0.3, Callback = function(self) self:DoSound(Sound("wfoly_plr_ar_kilo433_reload_drum_empty_01")) end},
            ...
            {Time = 2.53, Callback = function(self) self:DoSound(Sound("mw_ar2.rotpush")) end},
    ...
    ["Reload_Empty_Fast"] = {
        ...
        Events = {
            ...
            {Time = 2.06, Callback = function(self) self:DoSound(Sound("wfoly_plr_ar_kilo433_reload_drum_empty_05")) end},
            {Time = 2.1, Callback = function(self) self:DoSound(Sound("wfoly_plr_ar_kilo433_reload_drum_045")) end},
            {Time = 2.53, Callback = function(self) self:DoSound(Sound("mw_ar2.rotate")) end},
            {Time = 2.93, Callback = function(self) self:DoSound(Sound("mw_ar2.push")) end},
            {Time = 2.95, Callback = function(self) self:EnableGrip() end},
        }
    },
  ...
  ["Reload_Empty_XmagLrg"] = {
   ...
   ["Reload_Empty_XmagLrg_Fast"] = {
    ...
    ["Firemode_Auto"] = {
        ...
        Events = {
            {Time = 0, Callback = function(self) self:EnableGrip() end},
            {Time = 0, Callback = function(self) self:DoSound("weapons/ar2/ar2_reload_push.wav") end}
        }
    },
